...
export type UpdateCheckoutItemQuantityMutationVariables = Exact<{
  checkoutId: Scalars['ID'];
  itemId: Scalars['ID'];
  quantity: Scalars['Int'];
}>;
...
export type UpdateCheckoutItemQuantityMutation = (
  { __typename?: 'Mutation' }
...
export const UpdateCheckoutItemQuantityDocument = gql`
    mutation UpdateCheckoutItemQuantity($checkoutId: ID!, $itemId: ID!, $quantity: Int!) {
  updateQuantity(checkoutId: $checkoutId, itemId: $itemId, quantity: $quantity) {
    ...Checkout
  }
}
    ${CheckoutFragmentDoc}`;
export type UpdateCheckoutItemQuantityMutationFn = Apollo.MutationFunction<UpdateCheckoutItemQuantityMutation, UpdateCheckoutItemQuantityMutationVariables>;
 ...
 * });
 */
export function useUpdateCheckoutItemQuantityMutation(baseOptions?: Apollo.MutationHookOptions<UpdateCheckoutItemQuantityMutation, UpdateCheckoutItemQuantityMutationVariables>) {
        return Apollo.useMutation<UpdateCheckoutItemQuantityMutation, UpdateCheckoutItemQuantityMutationVariables>(UpdateCheckoutItemQuantityDocument, baseOptions);
      }
export type UpdateCheckoutItemQuantityMutationHookResult = ReturnType<typeof useUpdateCheckoutItemQuantityMutation>;
export type UpdateCheckoutItemQuantityMutationResult = Apollo.MutationResult<UpdateCheckoutItemQuantityMutation>;
export type UpdateCheckoutItemQuantityMutationOptions = Apollo.BaseMutationOptions<UpdateCheckoutItemQuantityMutation, UpdateCheckoutItemQuantityMutationVariables>;