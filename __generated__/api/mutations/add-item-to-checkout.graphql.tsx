...
export type AddItemToCheckoutMutation = (
  { __typename?: 'Mutation' }
  & { addItem?: Maybe<(
    { __typename?: 'Checkout' }
    & CheckoutFragment
...
export const AddItemToCheckoutDocument = gql`
    mutation AddItemToCheckout($checkoutId: ID!, $productId: ID!, $quantity: Int!, $option: String!) {
  addItem(checkoutId: $checkoutId, productId: $productId, quantity: $quantity, option: $option) {
    ...Checkout
  }
}
    ${CheckoutFragmentDoc}`;
export type AddItemToCheckoutMutationFn = Apollo.MutationFunction<AddItemToCheckoutMutation, AddItemToCheckoutMutationVariables>;
 ...
 * });
 */
export function useAddItemToCheckoutMutation(baseOptions?: Apollo.MutationHookOptions<AddItemToCheckoutMutation, AddItemToCheckoutMutationVariables>) {
        return Apollo.useMutation<AddItemToCheckoutMutation, AddItemToCheckoutMutationVariables>(AddItemToCheckoutDocument, baseOptions);
      }
export type AddItemToCheckoutMutationHookResult = ReturnType<typeof useAddItemToCheckoutMutation>;
export type AddItemToCheckoutMutationResult = Apollo.MutationResult<AddItemToCheckoutMutation>;
export type AddItemToCheckoutMutationOptions = Apollo.BaseMutationOptions<AddItemToCheckoutMutation, AddItemToCheckoutMutationVariables>;