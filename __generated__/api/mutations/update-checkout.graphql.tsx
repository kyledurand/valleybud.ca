...
export const UpdateCheckoutDocument = gql`
    mutation UpdateCheckout($checkoutId: ID!, $orderType: OrderType!, $pricingType: PricingType!) {
  updateCheckout(checkoutId: $checkoutId, orderType: $orderType, pricingType: $pricingType) {
    ...Checkout
  }
}
    ${CheckoutFragmentDoc}`;
...
export function useUpdateCheckoutMutation(baseOptions?: Apollo.MutationHookOptions<UpdateCheckoutMutation, UpdateCheckoutMutationVariables>) {
        return Apollo.useMutation<UpdateCheckoutMutation, UpdateCheckoutMutationVariables>(UpdateCheckoutDocument, baseOptions);
      }
