...
export declare type RemoveItemFromCheckoutMutationVariables = Exact<{
    checkoutId: Scalars['ID'];
    itemId: Scalars['ID'];
}>;
export declare type RemoveItemFromCheckoutMutation = ({
    __typename?: 'Mutation';
} & {
    removeItem?: Maybe<({
        __typename?: 'Checkout';
...
export declare const RemoveItemFromCheckoutDocument: Apollo.DocumentNode;
export declare type RemoveItemFromCheckoutMutationFn = Apollo.MutationFunction<RemoveItemFromCheckoutMutation, RemoveItemFromCheckoutMutationVariables>;
/**
 ...
 * });
 */
export declare function useRemoveItemFromCheckoutMutation(baseOptions?: Apollo.MutationHookOptions<RemoveItemFromCheckoutMutation, RemoveItemFromCheckoutMutationVariables>): Apollo.MutationTuple<RemoveItemFromCheckoutMutation, Exact<{
    checkoutId: string;
    itemId: string;
}>>;
export declare type RemoveItemFromCheckoutMutationHookResult = ReturnType<typeof useRemoveItemFromCheckoutMutation>;
export declare type RemoveItemFromCheckoutMutationResult = Apollo.MutationResult<RemoveItemFromCheckoutMutation>;
export declare type RemoveItemFromCheckoutMutationOptions = Apollo.BaseMutationOptions<RemoveItemFromCheckoutMutation, RemoveItemFromCheckoutMutationVariables>;
