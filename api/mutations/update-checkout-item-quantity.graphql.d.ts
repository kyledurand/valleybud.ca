/* 5dbb881757289c9567b5bc256d10dbf8b797a81d
...
export declare type MutationCreateCheckoutArgs = {
    address?: Maybe<CheckoutAddressInput>;
    metadata?: Maybe<Scalars['JSON']>;
    orderType: OrderType;
    pricingType: PricingType;
};
export declare type MutationAddItemArgs = {
    checkoutId: Scalars['ID'];
    quantity: Scalars['Int'];
    option: Scalars['String'];
    productId: Scalars['ID'];
};
export declare type MutationRemoveItemArgs = {
    checkoutId: Scalars['ID'];
    itemId: Scalars['ID'];
};
export declare type MutationUpdateQuantityArgs = {
    checkoutId: Scalars['ID'];
    itemId: Scalars['ID'];
    quantity: Scalars['Int'];
};
export declare type MutationUpdateCheckoutArgs = {
    address?: Maybe<CheckoutAddressInput>;
    checkoutId: Scalars['ID'];
    metadata?: Maybe<Scalars['JSON']>;
...
export declare type QueryCheckoutArgs = {
    id: Scalars['ID'];
};
...
export declare type QueryMenuArgs = {
...
export declare type CheckoutAddress = {
...
export declare type CheckoutAddressGeometry = {
    __typename?: 'CheckoutAddressGeometry';
    coordinates?: Maybe<Array<Scalars['Float']>>;
    type?: Maybe<Scalars['String']>;
};
export declare type CheckoutAddressInput = {
    city: Scalars['String'];
...
export declare type ItemDiscounts = {
    __typename?: 'ItemDiscounts';
    total?: Maybe<Scalars['Int']>;
};
export declare type ItemTaxes = {
...
export declare type MedicalCard = {
...
export declare type MenuFilter = {
...
export declare type MenuSort = {
    direction: SortDirection;
    key: MenuSortKey;
};
export declare type PosMetaDataFilter = {
    category?: Maybe<Scalars['String']>;
};
export declare type PotencyRange = {
...
export declare type OrdersSort = {
    direction: SortDirection;
    key: OrdersSortKey;
};
...
export declare type ReservationDate = {
...
export declare type ActiveCannabinoid = {
...
export declare type Cannabinoid = {
...
export declare type RetailersNearLocationInput = {
...
export declare type RetailerNearLocation = {
...
export declare type BannerColorConfiguration = {
...
export declare type CategoryLimit = {
    __typename?: 'CategoryLimit';
    name?: Maybe<Scalars['String']>;
    value?: Maybe<Scalars['String']>;
};
export declare type DeliverySettings = {
...
export declare type HoursSettings = {
...
export declare type SpecialHoursDay = {
...
export declare type SpecialEmail = {
...
export declare type SpecialSchedule = {
...
export declare type SpecialMenuDisplay = {
    __typename?: 'SpecialMenuDisplay';
    name?: Maybe<Scalars['String']>;
    description?: Maybe<Scalars['String']>;
    image?: Maybe<Scalars['String']>;
};
export declare type Customers = {
...
export declare type ActiveTerpene = {
...
export declare type UpdateCheckoutItemQuantityMutationVariables = Exact<{
    checkoutId: Scalars['ID'];
    itemId: Scalars['ID'];
    quantity: Scalars['Int'];
}>;
export declare type UpdateCheckoutItemQuantityMutation = ({
    __typename?: 'Mutation';
} & {
    updateQuantity?: Maybe<({
        __typename?: 'Checkout';
    } & CheckoutFragment)>;
});
export declare type CheckoutFragment = ({
    __typename?: 'Checkout';
...
export declare type CheckoutItemFragment = ({
    __typename?: 'Item';
...
export declare const UpdateCheckoutItemQuantityDocument: Apollo.DocumentNode;
export declare type UpdateCheckoutItemQuantityMutationFn = Apollo.MutationFunction<UpdateCheckoutItemQuantityMutation, UpdateCheckoutItemQuantityMutationVariables>;
/**
 * __useUpdateCheckoutItemQuantityMutation__
 *
 * To run a mutation, you first call `useUpdateCheckoutItemQuantityMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateCheckoutItemQuantityMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateCheckoutItemQuantityMutation, { data, loading, error }] = useUpdateCheckoutItemQuantityMutation({
 *   variables: {
 ...
 * });
 */
export declare function useUpdateCheckoutItemQuantityMutation(baseOptions?: Apollo.MutationHookOptions<UpdateCheckoutItemQuantityMutation, UpdateCheckoutItemQuantityMutationVariables>): Apollo.MutationTuple<UpdateCheckoutItemQuantityMutation, Exact<{
    checkoutId: string;
    itemId: string;
    quantity: number;
}>>;
export declare type UpdateCheckoutItemQuantityMutationHookResult = ReturnType<typeof useUpdateCheckoutItemQuantityMutation>;
export declare type UpdateCheckoutItemQuantityMutationResult = Apollo.MutationResult<UpdateCheckoutItemQuantityMutation>;
export declare type UpdateCheckoutItemQuantityMutationOptions = Apollo.BaseMutationOptions<UpdateCheckoutItemQuantityMutation, UpdateCheckoutItemQuantityMutationVariables>;
