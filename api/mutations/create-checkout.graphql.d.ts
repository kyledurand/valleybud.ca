/* 944208a942d7a340929ea88c6162bf5dcdfd7323
...
export declare type CreateCheckoutMutationVariables = Exact<{
    orderType: OrderType;
    pricingType: PricingType;
}>;
export declare type CreateCheckoutMutation = ({
    __typename?: 'Mutation';
} & {
...
export declare const CreateCheckoutDocument: Apollo.DocumentNode;
export declare type CreateCheckoutMutationFn = Apollo.MutationFunction<CreateCheckoutMutation, CreateCheckoutMutationVariables>;
/**
 ...
 * });
 */
export declare function useCreateCheckoutMutation(baseOptions?: Apollo.MutationHookOptions<CreateCheckoutMutation, CreateCheckoutMutationVariables>): Apollo.MutationTuple<CreateCheckoutMutation, Exact<{
    orderType: OrderType;
    pricingType: PricingType;
}>>;
export declare type CreateCheckoutMutationHookResult = ReturnType<typeof useCreateCheckoutMutation>;
export declare type CreateCheckoutMutationResult = Apollo.MutationResult<CreateCheckoutMutation>;
export declare type CreateCheckoutMutationOptions = Apollo.BaseMutationOptions<CreateCheckoutMutation, CreateCheckoutMutationVariables>;
