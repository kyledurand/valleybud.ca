/* 4d75432a5b99de1e633fbc0597a1e42b405d9cdb
...
export declare type UpdateCheckoutMutationVariables = Exact<{
    checkoutId: Scalars['ID'];
    orderType: OrderType;
    pricingType: PricingType;
}>;
export declare type UpdateCheckoutMutation = ({
    __typename?: 'Mutation';
} & {
...
export declare type UpdateCheckoutMutationFn = Apollo.MutationFunction<UpdateCheckoutMutation, UpdateCheckoutMutationVariables>;
/**
...
export declare type UpdateCheckoutMutationHookResult = ReturnType<typeof useUpdateCheckoutMutation>;
export declare type UpdateCheckoutMutationResult = Apollo.MutationResult<UpdateCheckoutMutation>;
export declare type UpdateCheckoutMutationOptions = Apollo.BaseMutationOptions<UpdateCheckoutMutation, UpdateCheckoutMutationVariables>;
