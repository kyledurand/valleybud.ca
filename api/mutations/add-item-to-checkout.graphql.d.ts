/* b1a7dd908151947c57790bb4131eab3e01e48ec5
...
export declare type AddItemToCheckoutMutationVariables = Exact<{
    checkoutId: Scalars['ID'];
    productId: Scalars['ID'];
    quantity: Scalars['Int'];
    option: Scalars['String'];
}>;
export declare type AddItemToCheckoutMutation = ({
    __typename?: 'Mutation';
} & {
    addItem?: Maybe<({
        __typename?: 'Checkout';
...
export declare const AddItemToCheckoutDocument: Apollo.DocumentNode;
export declare type AddItemToCheckoutMutationFn = Apollo.MutationFunction<AddItemToCheckoutMutation, AddItemToCheckoutMutationVariables>;
/**
 * __useAddItemToCheckoutMutation__
 *
 * To run a mutation, you first call `useAddItemToCheckoutMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddItemToCheckoutMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [addItemToCheckoutMutation, { data, loading, error }] = useAddItemToCheckoutMutation({
 *   variables: {
 ...
 * });
 */
export declare function useAddItemToCheckoutMutation(baseOptions?: Apollo.MutationHookOptions<AddItemToCheckoutMutation, AddItemToCheckoutMutationVariables>): Apollo.MutationTuple<AddItemToCheckoutMutation, Exact<{
    checkoutId: string;
    productId: string;
    quantity: number;
    option: string;
}>>;
export declare type AddItemToCheckoutMutationHookResult = ReturnType<typeof useAddItemToCheckoutMutation>;
export declare type AddItemToCheckoutMutationResult = Apollo.MutationResult<AddItemToCheckoutMutation>;
export declare type AddItemToCheckoutMutationOptions = Apollo.BaseMutationOptions<AddItemToCheckoutMutation, AddItemToCheckoutMutationVariables>;
