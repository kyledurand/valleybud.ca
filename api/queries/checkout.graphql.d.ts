/* b71f9fee5e4a9d873336ad219c47bdf2cd822608
...
export declare type CheckoutQueryVariables = Exact<{
    id: Scalars['ID'];
}>;
 ...
 * });
 */
export declare function useCheckoutQuery(baseOptions?: Apollo.QueryHookOptions<CheckoutQuery, CheckoutQueryVariables>): Apollo.QueryResult<CheckoutQuery, Exact<{
    id: string;
}>>;
export declare function useCheckoutLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CheckoutQuery, CheckoutQueryVariables>): Apollo.QueryTuple<CheckoutQuery, Exact<{
    id: string;
}>>;
export declare type CheckoutQueryHookResult = ReturnType<typeof useCheckoutQuery>;
export declare type CheckoutLazyQueryHookResult = ReturnType<typeof useCheckoutLazyQuery>;
export declare type CheckoutQueryResult = Apollo.QueryResult<CheckoutQuery, CheckoutQueryVariables>;
