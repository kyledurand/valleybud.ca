...
export type GetSpecialsListQueryVariables = Exact<{
    retailerId: Scalars['ID'];
}>;
export type GetSpecialsListQuery = ({
    __typename?: 'Query';
} & {
...
export type SpecialsItemFragment = ({
    __typename?: 'Special';
} & Pick<Special, 'id' | 'name' | 'type' | 'redemptionLimit' | 'menuType'> & {
    emailConfiguration?: Maybe<({
        __typename?: 'SpecialEmail';
    } & Pick<SpecialEmail, 'description' | 'descriptionHtml' | 'subject' | 'heading' | 'enabled'>)>;
    scheduleConfiguration?: Maybe<({
        __typename?: 'SpecialSchedule';
    } & Pick<SpecialSchedule, 'startStamp' | 'endStamp' | 'days' | 'setEndDate' | 'endDate' | 'recurringStartTime' | 'recurringEndTime'>)>;
 ...
 * });
 */
export declare function useGetSpecialsListQuery(baseOptions?: Apollo.QueryHookOptions<GetSpecialsListQuery, GetSpecialsListQueryVariables>): Apollo.QueryResult<GetSpecialsListQuery, Exact<{
    retailerId: string;
}>>;
export declare function useGetSpecialsListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSpecialsListQuery, GetSpecialsListQueryVariables>): Apollo.QueryTuple<GetSpecialsListQuery, Exact<{
    retailerId: string;
}>>;
export type GetSpecialsListQueryHookResult = ReturnType<typeof useGetSpecialsListQuery>;
export type GetSpecialsListLazyQueryHookResult = ReturnType<typeof useGetSpecialsListLazyQuery>;
export type GetSpecialsListQueryResult = Apollo.QueryResult<GetSpecialsListQuery, GetSpecialsListQueryVariables>;
