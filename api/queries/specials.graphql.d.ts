/* 2b7ba27cb3bb3ddb73757334a7fd5ba0e473cc81
...
export declare type QueryRetailersNearLocationArgs = {
  location: RetailersNearLocationInput;
};
export declare type QuerySpecialsArgs = {
  retailerId: Scalars["ID"];
};
...
export declare type PosMetaData = {
...
export declare type GetSpecialsListQueryVariables = Exact<{
  retailerId: Scalars["ID"];
}>;
export declare type GetSpecialsListQuery = {
  __typename?: "Query";
} & {
  specials?: Maybe<
    Array<
      Maybe<
        {
          __typename?: "Special";
        } & SpecialsItemFragment
      >
    >
  >;
};
export declare type SpecialsItemFragment = {
  __typename?: "Special";
} & Pick<Special, "id" | "name" | "type" | "redemptionLimit" | "menuType"> & {
    emailConfiguration?: Maybe<
      {
        __typename?: "SpecialEmail";
      } & Pick<
        SpecialEmail,
        "description" | "descriptionHtml" | "subject" | "heading" | "enabled"
      >
    >;
    scheduleConfiguration?: Maybe<
      {
        __typename?: "SpecialSchedule";
      } & Pick<
        SpecialSchedule,
      ...
      >
    >;
    menuDisplayConfiguration?: Maybe<
      {
        __typename?: "SpecialMenuDisplay";
      } & Pick<SpecialMenuDisplay, "name" | "description" | "image">
    >;
  };
export declare const SpecialsItemFragmentDoc: Apollo.DocumentNode;
export declare const GetSpecialsListDocument: Apollo.DocumentNode;
/**
 * __useGetSpecialsListQuery__
 *
 * To run a query within a React component, call `useGetSpecialsListQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetSpecialsListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export declare function useGetSpecialsListQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetSpecialsListQuery,
    GetSpecialsListQueryVariables
  >
): Apollo.QueryResult<
  GetSpecialsListQuery,
  Exact<{
...
>;
export declare function useGetSpecialsListLazyQuery(
...
>;
export declare type GetSpecialsListQueryHookResult = ReturnType<
  typeof useGetSpecialsListQuery
>;
export declare type GetSpecialsListLazyQueryHookResult = ReturnType<
  typeof useGetSpecialsListLazyQuery
>;
export declare type GetSpecialsListQueryResult = Apollo.QueryResult<
  GetSpecialsListQuery,
  GetSpecialsListQueryVariables
>;
