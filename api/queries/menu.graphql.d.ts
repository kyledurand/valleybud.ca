/* b427e489271cfd63ba2d9158ade4a2a66a3db98f
...
export declare type MenuQueryVariables = Exact<{
  category?: Maybe<Category>;
  search?: Maybe<Scalars["String"]>;
  retailerId: Scalars["ID"];
  brandId?: Maybe<Scalars["String"]>;
}>;
export declare type MenuQuery = {
  __typename?: "Query";
} & {
  menu?: Maybe<
    {
 ...
 * });
 */
export declare function useMenuQuery(
...
>;
export declare function useMenuLazyQuery(
...
>;
export declare type MenuQueryHookResult = ReturnType<typeof useMenuQuery>;
export declare type MenuLazyQueryHookResult = ReturnType<
  typeof useMenuLazyQuery
>;
export declare type MenuQueryResult = Apollo.QueryResult<
  MenuQuery,
  MenuQueryVariables
>;
