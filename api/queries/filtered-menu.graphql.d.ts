/* 112664a02d6f5c05dc1c9490585808fe6057d119
...
export type FilteredMenuQueryVariables = Exact<{
    retailerId: Scalars['ID'];
    category?: Maybe<Category>;
    search?: Maybe<Scalars['String']>;
    brandId?: Maybe<Scalars['String']>;
    ...
    sortKey: MenuSortKey;
    minimumThc?: Maybe<Scalars['Float']>;
    maximumThc?: Maybe<Scalars['Float']>;
    minimumCbd?: Maybe<Scalars['Float']>;
    maximumCbd?: Maybe<Scalars['Float']>;
    unit?: Maybe<PotencyUnit>;
    weights?: Maybe<Array<Scalars['String']>>;
    strainType?: Maybe<StrainType>;
    subcategory?: Maybe<Subcategory>;
}>;
export type FilteredMenuQuery = ({
    __typename?: 'Query';
} & {
    menu?: Maybe<({
        __typename?: 'Menu';
...
export declare const FilteredMenuDocument: Apollo.DocumentNode;
/**
 * __useFilteredMenuQuery__
 *
 * To run a query within a React component, call `useFilteredMenuQuery` and pass it any options that fit your needs.
 * When your component renders, `useFilteredMenuQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useFilteredMenuQuery({
 *   variables: {
 ...
 *      minimumThc: // value for 'minimumThc'
 *      maximumThc: // value for 'maximumThc'
 *      minimumCbd: // value for 'minimumCbd'
 *      maximumCbd: // value for 'maximumCbd'
 *      unit: // value for 'unit'
 *      weights: // value for 'weights'
 *      strainType: // value for 'strainType'
 *      subcategory: // value for 'subcategory'
 *   },
 * });
 */
export declare function useFilteredMenuQuery(baseOptions?: Apollo.QueryHookOptions<FilteredMenuQuery, FilteredMenuQueryVariables>): Apollo.QueryResult<FilteredMenuQuery, Exact<{
    retailerId: string;
    ...
    sortDirection: SortDirection;
    sortKey: MenuSortKey;
    minimumThc?: Maybe<number> | undefined;
    maximumThc?: Maybe<number> | undefined;
    minimumCbd?: Maybe<number> | undefined;
    maximumCbd?: Maybe<number> | undefined;
    unit?: Maybe<PotencyUnit> | undefined;
    weights?: Maybe<string[]> | undefined;
    strainType?: Maybe<StrainType> | undefined;
    subcategory?: Maybe<Subcategory> | undefined;
}>>;
export declare function useFilteredMenuLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FilteredMenuQuery, FilteredMenuQueryVariables>): Apollo.QueryTuple<FilteredMenuQuery, Exact<{
    retailerId: string;
    category?: Maybe<Category> | undefined;
    search?: Maybe<string> | undefined;
    brandId?: Maybe<string> | undefined;
...
export type FilteredMenuQueryHookResult = ReturnType<typeof useFilteredMenuQuery>;
export type FilteredMenuLazyQueryHookResult = ReturnType<typeof useFilteredMenuLazyQuery>;
export type FilteredMenuQueryResult = Apollo.QueryResult<FilteredMenuQuery, FilteredMenuQueryVariables>;
