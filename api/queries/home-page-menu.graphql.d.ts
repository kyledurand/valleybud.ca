/* a49c87500c792affb63e65f55c13f7d8d71995da
...
export declare type HomePageMenuQueryVariables = Exact<{
    category?: Maybe<Category>;
}>;
export declare type HomePageMenuQuery = ({
    __typename?: 'Query';
} & {
    menu?: Maybe<({
        __typename?: 'Menu';
...
export declare type MenuProductFragment = ({
    __typename?: 'Product';
} & Pick<Product, 'category' | 'description' | 'id' | 'image' | 'name' | 'strainType'> & {
    brand?: Maybe<({
        __typename?: 'Brand';
    } & Pick<Brand, 'name'>)>;
    potencyCbd?: Maybe<({
        __typename?: 'Potency';
    } & Pick<Potency, 'formatted'>)>;
    potencyThc?: Maybe<({
        __typename?: 'Potency';
    } & Pick<Potency, 'formatted'>)>;
    variants: Array<({
        __typename?: 'ProductVariant';
    } & Pick<ProductVariant, 'option' | 'priceMed' | 'priceRec' | 'specialPriceMed' | 'specialPriceRec'>)>;
});
export declare const MenuProductFragmentDoc: Apollo.DocumentNode;
export declare const HomePageMenuDocument: Apollo.DocumentNode;
/**
 * __useHomePageMenuQuery__
 *
 * To run a query within a React component, call `useHomePageMenuQuery` and pass it any options that fit your needs.
 * When your component renders, `useHomePageMenuQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useHomePageMenuQuery({
 *   variables: {
 *      category: // value for 'category'
 *   },
 * });
 */
export declare function useHomePageMenuQuery(baseOptions?: Apollo.QueryHookOptions<HomePageMenuQuery, HomePageMenuQueryVariables>): Apollo.QueryResult<HomePageMenuQuery, Exact<{
    category?: Category | null | undefined;
}>>;
export declare function useHomePageMenuLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<HomePageMenuQuery, HomePageMenuQueryVariables>): Apollo.QueryTuple<HomePageMenuQuery, Exact<{
    category?: Category | null | undefined;
}>>;
export declare type HomePageMenuQueryHookResult = ReturnType<typeof useHomePageMenuQuery>;
export declare type HomePageMenuLazyQueryHookResult = ReturnType<typeof useHomePageMenuLazyQuery>;
export declare type HomePageMenuQueryResult = Apollo.QueryResult<HomePageMenuQuery, HomePageMenuQueryVariables>;
