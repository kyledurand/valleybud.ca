...
export type BrandsQueryQueryVariables = Exact<{
    retailerId: Scalars['ID'];
}>;
 ...
 * });
 */
export declare function useBrandsQueryQuery(baseOptions?: Apollo.QueryHookOptions<BrandsQueryQuery, BrandsQueryQueryVariables>): Apollo.QueryResult<BrandsQueryQuery, Exact<{
    retailerId: string;
}>>;
export declare function useBrandsQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<BrandsQueryQuery, BrandsQueryQueryVariables>): Apollo.QueryTuple<BrandsQueryQuery, Exact<{
    retailerId: string;
}>>;
export type BrandsQueryQueryHookResult = ReturnType<typeof useBrandsQueryQuery>;
export type BrandsQueryLazyQueryHookResult = ReturnType<typeof useBrandsQueryLazyQuery>;
export type BrandsQueryQueryResult = Apollo.QueryResult<BrandsQueryQuery, BrandsQueryQueryVariables>;
