/* d6d357476d62c806c5cc3ecf4573ffa0662cc077
...
export declare type BrandFragmentFragment = {
  __typename?: "Brand";
} & Pick<Brand, "description" | "id" | "imageUrl" | "name">;
export declare type BrandsQueryQueryVariables = Exact<{
  retailerId: Scalars["ID"];
}>;
export declare type BrandsQueryQuery = {
  __typename?: "Query";
} & {
  menu?: Maybe<
    {
      ...
      brands: Array<
        {
          __typename?: "Brand";
        } & BrandFragmentFragment
      >;
    }
  >;
};
export declare const BrandFragmentFragmentDoc: Apollo.DocumentNode;
export declare const BrandsQueryDocument: Apollo.DocumentNode;
/**
 * __useBrandsQueryQuery__
 *
 * To run a query within a React component, call `useBrandsQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `useBrandsQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useBrandsQueryQuery({
 *   variables: {
 *      retailerId: // value for 'retailerId'
 *   },
 * });
 */
export declare function useBrandsQueryQuery(
  baseOptions?: Apollo.QueryHookOptions<
    BrandsQueryQuery,
    BrandsQueryQueryVariables
  >
): Apollo.QueryResult<
  BrandsQueryQuery,
  Exact<{
...
>;
export declare function useBrandsQueryLazyQuery(
...
>;
export declare type BrandsQueryQueryHookResult = ReturnType<
  typeof useBrandsQueryQuery
>;
export declare type BrandsQueryLazyQueryHookResult = ReturnType<
  typeof useBrandsQueryLazyQuery
>;
export declare type BrandsQueryQueryResult = Apollo.QueryResult<
  BrandsQueryQuery,
  BrandsQueryQueryVariables
>;
