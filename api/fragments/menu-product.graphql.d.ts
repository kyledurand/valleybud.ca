/* 54f66a573fd06923ac43209b1a6cfcf368af3249
...
export type TerpeneFragmentFragment = ({
    __typename?: 'Terpene';
} & Pick<Terpene, 'aliasList' | 'aromas' | 'description' | 'effects' | 'id' | 'name' | 'potentialHealthBenefits' | 'unitSymbol'>);
export type ActiveTerpeneFragmentFragment = ({
    __typename?: 'ActiveTerpene';
} & Pick<ActiveTerpene, 'id' | 'name' | 'terpeneId' | 'unit' | 'unitSymbol' | 'value'> & {
    terpene?: Maybe<({
        __typename?: 'Terpene';
    } & TerpeneFragmentFragment)>;
});
...
export type ProductFragmentFragment = ({
    ...
    terpenes?: Maybe<Array<Maybe<({
        __typename?: 'ActiveTerpene';
    } & ActiveTerpeneFragmentFragment)>>>;
    cannabinoids?: Maybe<Array<Maybe<({
        __typename?: 'ActiveCannabinoid';
    } & ActiveCannabinoidFragmentFragment)>>>;
});
export declare const TerpeneFragmentFragmentDoc: import("@apollo/client").DocumentNode;
export declare const ActiveTerpeneFragmentFragmentDoc: import("@apollo/client").DocumentNode;
export declare const ActiveCannabinoidFragmentFragmentDoc: import("@apollo/client").DocumentNode;
export declare const ProductFragmentFragmentDoc: import("@apollo/client").DocumentNode;
